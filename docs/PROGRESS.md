...
**Последнее обновление:** 2026-06-28 — единая высота оверлея загрузки на всех панелях (справочники, калькулятор, заказы, пользователи; админ, менеджер, публичный UI).
