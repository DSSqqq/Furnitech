...
**Последнее обновление:** 2026-05-24 — режим «только десктоп» (**`desktop-layout.css`**, viewport **1280**); эскиз шага 3 при **0** в полях → **500×200**; ранее — потолок высоты эскиза, UI форм типов.
