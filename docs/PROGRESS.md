...
**Последнее обновление:** 2026-05-27 — эскиз: выравнивание подписей размеров петель (лево/право) и единый зазор подпись ↔ линия на всех шагах.

### Изменения 2026-05-27 (frontend — подписи размеров на эскизе)
