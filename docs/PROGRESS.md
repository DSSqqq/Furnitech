...
**Последнее обновление:** 2026-05-18 — **`MaterialClassPickModal`**: убран дублирующий запрос **`fetchMaterialClasses()`** при открытии пикера (корень «База классов» берёт список из **`allClasses`**).
