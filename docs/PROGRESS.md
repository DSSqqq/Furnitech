...
**Последнее обновление:** 2026-05-28 — PDF шага 8: один альбомный лист, эскиз справа на бланке.
...
- На бланке эскиз **без цепочек размеров** петель/ручки (только габариты H×W, маркеры, карточка «Лицевая сторона»); полные цепочки остаются в UI калькулятора.
