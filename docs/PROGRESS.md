...
**Последнее обновление:** 2026-05-16 (карточка материала **`MaterialForm`**: две вкладки, сетка общих полей, округление; блок ед. изм. + текстура напротив **`FtSelect`**; см. блок ниже + мобильная вёрстка).
