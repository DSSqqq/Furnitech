...
**Последнее обновление:** 2026-05-24 — калькулятор: потолок высоты эскиза (**1700 мм**), UI форм типов (флаги New/Hit/Sale, подписи, шаг 4); ранее — 4 фото карточки, **`MaterialSearchModal`**, габариты шага 3.
