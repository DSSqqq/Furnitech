...
**Последнее обновление:** 2026-05-16 (импорт материалов ↔ **`TextureItem`**: stem имени, цвет vs текстура, путь из **«Текстура (импорт):»** в примечании; **Supabase Storage** — см. блоки ниже).
