...
**Последнее обновление:** 2026-05-27 — админка «Заказы» и «Пользователи»: вёрстка таблицы, светлая тема статусов.
...
- Листы фасадов в PDF теперь повторяют отображение эскиза шага 7: рамка, заполнение, маркеры петель/ручки, цепочки размеров и главные габариты, а внутри фасада добавлена карточка **«ЛИЦЕВАЯ СТОРОНА ФАСАДА»** с полями **Профиль / Цвет / В × Ш / Наполнение**.
