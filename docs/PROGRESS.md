...
**Последнее обновление:** 2026-05-24 — светлая/тёмная тема SPA (переключатель в шапке админки, CSS-переменные `--ft-*`); ранее — фиксированная ширина панели админ-калькулятора до «Шаг 6».
...
- Переключатель в **`admin-header-top`** (иконка солнце/луна, **`border-radius: 10px`**, без подписи) — слева от **«Выйти»**; у **`.admin-logout`** то же скругление **10px**.
