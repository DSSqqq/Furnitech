...
- **Карточка (модалка):** вкладки **«Общие параметры»**, **«Доп. параметры»**, **«Параметры текстуры»** — открытие по **шестерёнке** в строке списка (ранее также **«Перейти»** из **`MaterialSearchModal`** на вкладке материалов — кнопка поиска снята в 2026-05-12).
