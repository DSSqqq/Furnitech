...
| `calculator/Step3FrameSizes.css` | Сетка `frame3`, `.frame3-dim-drawing` (**`--right`**, **`--bottom`**), цепочки **`.hinge-chain-dim`** (**`--tracked`**, **`--narrow`**), слой **`frame3-hinge-dim-layer`**. |
