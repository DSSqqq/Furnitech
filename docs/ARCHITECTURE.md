...
- `thickness`, `min_length`, `max_length`, `min_width`, `max_width` — **«Доп. параметры»** (ограничения габаритов / задел калькулятора).
...
- `min_length`, `max_length`, `min_width`, `max_width` (лимиты габаритов, float)
